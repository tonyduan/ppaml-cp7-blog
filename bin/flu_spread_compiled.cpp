...
const int _BURN_IN = 999990;
int _tot_round = -999990;
...
TruncatedGauss TruncatedGauss40255168;
TruncatedGauss TruncatedGauss40255680;
Gaussian Gaussian40256320;
BooleanDistrib BooleanDistrib40267424;
BooleanDistrib BooleanDistrib40271424;
Gaussian Gaussian40275552;
Gaussian Gaussian40362544;
...
void _init_storage()
{
  ...
  TruncatedGauss40255168.init(1.50000000,0.50000000,1.00000000,2.50000000);
  TruncatedGauss40255680.init(0.50000000,0.50000000,0.000000,0.75000000);
  Gaussian40256320.init(-5.00000000,0.10000000);
...
{
  return TruncatedGauss40255168.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss40255168.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss40255168.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss40255168.gen();
}
...
{
  return TruncatedGauss40255680.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss40255680.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=TruncatedGauss40255680.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=TruncatedGauss40255680.gen();
}
...
{
  return Gaussian40256320.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian40256320.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian40256320.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian40256320.gen();
}
...
{
  return BooleanDistrib40267424.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib40267424.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib40267424.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib40267424.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib40267424.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib40267424.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib40267424.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib40267424.gen());
}
...
{
  return BooleanDistrib40271424.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib40271424.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib40271424.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib40271424.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib40271424.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib40271424.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib40271424.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib40271424.gen());
}
...
{
  return Gaussian40275552.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian40275552.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian40275552.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian40275552.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian40275552.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian40275552.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian40275552.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian40275552.gen());
}
