...
Gaussian Gaussian36190896;
BooleanDistrib BooleanDistrib36202112;
BooleanDistrib BooleanDistrib36206112;
Gaussian Gaussian36210240;
Gaussian Gaussian36382608;
...
void _init_storage()
{
  ...
  Gaussian36190896.init(-5.00000000,0.10000000);
...
{
  return Gaussian36190896.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian36190896.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian36190896.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian36190896.gen();
}
...
{
  return BooleanDistrib36202112.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib36202112.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib36202112.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib36202112.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib36202112.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib36202112.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib36202112.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib36202112.gen());
}
...
{
  return BooleanDistrib36206112.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib36206112.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib36206112.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib36206112.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib36206112.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib36206112.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib36206112.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib36206112.gen());
}
...
{
  return Gaussian36210240.init(_mem_bias->getval()+__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian36210240.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian36210240.init(_mem_bias->getcache()+__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian36210240.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian36210240.init(_mem_bias->getval()+__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian36210240.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian36210240.init(_mem_bias->getcache()+__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian36210240.gen());
}
