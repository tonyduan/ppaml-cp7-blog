...
Gamma Gamma40080112;
Gamma Gamma40080432;
Gaussian Gaussian40080816;
Gaussian Gaussian40081200;
Gaussian Gaussian40085936;
BooleanDistrib BooleanDistrib40088592;
BooleanDistrib BooleanDistrib40091104;
Gaussian Gaussian40093504;
Gaussian Gaussian40170368;
...
void _init_storage()
{
  ...
  Gamma40079744.init(0.50000000,0.10000000);
  Gamma40080112.init(3.00000000,0.10000000);
  Gamma40080432.init(10.00000000,0.10000000);
  Gaussian40080816.init(0.000000,10.00000000);
  Gaussian40081200.init(0.000000,10.00000000);
...
{
  return Gamma40079744.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma40079744.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma40079744.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma40079744.gen();
}
...
{
  return Gamma40080112.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma40080112.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma40080112.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma40080112.gen();
}
...
{
  return Gamma40080432.loglikeli(val);
}
double _Var_tau2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma40080432.loglikeli(_t_val);
}
void _Var_tau2::sample()
{
  val=Gamma40080432.gen();
}
void _Var_tau2::sample_cache()
{
  cache_val=Gamma40080432.gen();
}
...
{
  return Gaussian40080816.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian40080816.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=Gaussian40080816.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=Gaussian40080816.gen();
}
...
{
  return Gaussian40081200.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian40081200.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian40081200.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian40081200.gen();
}
...
{
  return Gaussian40085936.init(0.000000,__fixed_D[c]),Gaussian40085936.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian40085936.init(0.000000,__fixed_D[c]),Gaussian40085936.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian40085936.init(0.000000,__fixed_D[c]),Gaussian40085936.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian40085936.init(0.000000,__fixed_D[c]),Gaussian40085936.gen());
}
...
{
  return BooleanDistrib40088592.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib40088592.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib40088592.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib40088592.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib40088592.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib40088592.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib40088592.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib40088592.gen());
}
...
{
  return BooleanDistrib40091104.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib40091104.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib40091104.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib40091104.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib40091104.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib40091104.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib40091104.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib40091104.gen());
}
...
{
  return Gaussian40093504.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian40093504.loglikeli(val);
}
double _Var_noise::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian40093504.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian40093504.loglikeli(_t_val);
}
void _Var_noise::sample()
{
  val=(Gaussian40093504.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian40093504.gen());
}
void _Var_noise::sample_cache()
{
  cache_val=(Gaussian40093504.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian40093504.gen());
}
