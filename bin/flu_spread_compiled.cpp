...
const int _BURN_IN = 1999900;
int _tot_round = -1999900;
...
TruncatedGauss TruncatedGauss140438824648512;
TruncatedGauss TruncatedGauss140438824649152;
Gaussian Gaussian140438824648912;
BooleanDistrib BooleanDistrib140438824658448;
BooleanDistrib BooleanDistrib140438824662272;
Gaussian Gaussian140438824665424;
Gaussian Gaussian140438824671008;
...
void _init_storage()
{
  ...
  TruncatedGauss140438824648512.init(0.75000000,0.50000000,0.000000,2.00000000);
  TruncatedGauss140438824649152.init(0.75000000,0.50000000,0.000000,2.00000000);
  Gaussian140438824648912.init(-5.00000000,0.10000000);
...
{
  return TruncatedGauss140438824648512.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss140438824648512.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss140438824648512.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss140438824648512.gen();
}
...
{
  return TruncatedGauss140438824649152.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss140438824649152.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=TruncatedGauss140438824649152.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=TruncatedGauss140438824649152.gen();
}
...
{
  return Gaussian140438824648912.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian140438824648912.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian140438824648912.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian140438824648912.gen();
}
...
{
  return BooleanDistrib140438824658448.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib140438824658448.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib140438824658448.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib140438824658448.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib140438824658448.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib140438824658448.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib140438824658448.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib140438824658448.gen());
}
...
{
  return BooleanDistrib140438824662272.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib140438824662272.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib140438824662272.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib140438824662272.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib140438824662272.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib140438824662272.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib140438824662272.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib140438824662272.gen());
}
...
{
  return Gaussian140438824665424.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]/9.00000000),Gaussian140438824665424.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian140438824665424.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]/9.00000000),Gaussian140438824665424.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian140438824665424.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]/9.00000000),Gaussian140438824665424.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian140438824665424.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]/9.00000000),Gaussian140438824665424.gen());
}
