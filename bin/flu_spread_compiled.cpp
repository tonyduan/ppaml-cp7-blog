...
void _print_answer();
const int _TOT_LOOP = 50000000;
const int _BURN_IN = 49999995;
int _tot_round = -49999995;
...
Gamma Gamma21730032;
Gamma Gamma21730352;
Gaussian Gaussian21730736;
Gaussian Gaussian21731120;
Gaussian Gaussian21735856;
BooleanDistrib BooleanDistrib21738512;
BooleanDistrib BooleanDistrib21741024;
Gaussian Gaussian21743424;
Gaussian Gaussian21820288;
...
void _init_storage()
{
  ...
  Gamma21729664.init(0.50000000,0.10000000);
  Gamma21730032.init(3.00000000,0.10000000);
  Gamma21730352.init(10.00000000,0.10000000);
  Gaussian21730736.init(0.000000,10.00000000);
  Gaussian21731120.init(0.000000,10.00000000);
...
{
  return Gamma21729664.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma21729664.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma21729664.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma21729664.gen();
}
...
{
  return Gamma21730032.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma21730032.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma21730032.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma21730032.gen();
}
...
{
  return Gamma21730352.loglikeli(val);
}
double _Var_tau2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma21730352.loglikeli(_t_val);
}
void _Var_tau2::sample()
{
  val=Gamma21730352.gen();
}
void _Var_tau2::sample_cache()
{
  cache_val=Gamma21730352.gen();
}
...
{
  return Gaussian21730736.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian21730736.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=Gaussian21730736.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=Gaussian21730736.gen();
}
...
{
  return Gaussian21731120.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian21731120.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian21731120.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian21731120.gen();
}
...
{
  return Gaussian21735856.init(0.000000,__fixed_D[c]),Gaussian21735856.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian21735856.init(0.000000,__fixed_D[c]),Gaussian21735856.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian21735856.init(0.000000,__fixed_D[c]),Gaussian21735856.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian21735856.init(0.000000,__fixed_D[c]),Gaussian21735856.gen());
}
...
{
  return BooleanDistrib21738512.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib21738512.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib21738512.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib21738512.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib21738512.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib21738512.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib21738512.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib21738512.gen());
}
...
{
  return BooleanDistrib21741024.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib21741024.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib21741024.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib21741024.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib21741024.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib21741024.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib21741024.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib21741024.gen());
}
...
{
  return Gaussian21743424.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian21743424.loglikeli(val);
}
double _Var_noise::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian21743424.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian21743424.loglikeli(_t_val);
}
void _Var_noise::sample()
{
  val=(Gaussian21743424.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian21743424.gen());
}
void _Var_noise::sample_cache()
{
  cache_val=(Gaussian21743424.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian21743424.gen());
}
...
int main()
{
  ...
  printf("\nsample time: %fs (#iter = %d)\n",__elapsed_seconds.count(),50000000);
  swift::_print_answer();
