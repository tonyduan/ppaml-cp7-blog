...
TruncatedGauss TruncatedGauss41937520;
TruncatedGauss TruncatedGauss41938032;
Gaussian Gaussian41938384;
BooleanDistrib BooleanDistrib41949712;
BooleanDistrib BooleanDistrib41953712;
Gaussian Gaussian41957840;
Gaussian Gaussian42015536;
...
void _init_storage()
{
  ...
  TruncatedGauss41937520.init(0.75000000,0.50000000,0.000000,2.00000000);
  TruncatedGauss41938032.init(0.75000000,0.50000000,0.000000,2.00000000);
  Gaussian41938384.init(-5.00000000,0.10000000);
...
{
  return TruncatedGauss41937520.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss41937520.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss41937520.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss41937520.gen();
}
...
{
  return TruncatedGauss41938032.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss41938032.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=TruncatedGauss41938032.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=TruncatedGauss41938032.gen();
}
...
{
  return Gaussian41938384.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian41938384.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian41938384.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian41938384.gen();
}
...
{
  return BooleanDistrib41949712.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib41949712.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib41949712.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib41949712.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib41949712.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib41949712.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib41949712.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib41949712.gen());
}
...
{
  return BooleanDistrib41953712.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib41953712.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib41953712.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib41953712.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib41953712.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib41953712.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib41953712.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib41953712.gen());
}
...
{
  return Gaussian41957840.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian41957840.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian41957840.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian41957840.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian41957840.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian41957840.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian41957840.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian41957840.gen());
}
