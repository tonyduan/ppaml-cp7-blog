...
Gamma Gamma23006000;
Gamma Gamma23006368;
TruncatedGauss TruncatedGauss23007136;
TruncatedGauss TruncatedGauss23007680;
Gaussian Gaussian23008128;
BooleanDistrib BooleanDistrib23019184;
BooleanDistrib BooleanDistrib23023184;
Gaussian Gaussian23027312;
Gaussian Gaussian23085008;
...
void _init_storage()
{
  ...
  Gamma23006000.init(1.05000000,0.50000000);
  Gamma23006368.init(3.00000000,0.10000000);
  TruncatedGauss23007136.init(0.75000000,0.50000000,0.000000,2.00000000);
  TruncatedGauss23007680.init(0.75000000,0.50000000,0.000000,2.00000000);
  Gaussian23008128.init(-5.00000000,0.10000000);
...
{
  return Gamma23006000.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma23006000.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma23006000.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma23006000.gen();
}
...
{
  return Gamma23006368.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma23006368.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma23006368.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma23006368.gen();
}
...
{
  return TruncatedGauss23007136.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss23007136.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss23007136.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss23007136.gen();
}
...
{
  return TruncatedGauss23007680.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss23007680.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=TruncatedGauss23007680.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=TruncatedGauss23007680.gen();
}
...
{
  return Gaussian23008128.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian23008128.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian23008128.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian23008128.gen();
}
...
{
  return BooleanDistrib23019184.init(exp(1.00000000*_mem_tau1->getval()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib23019184.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib23019184.init(exp(1.00000000*_mem_tau1->getcache()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib23019184.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib23019184.init(exp(1.00000000*_mem_tau1->getval()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib23019184.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib23019184.init(exp(1.00000000*_mem_tau1->getcache()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib23019184.gen());
}
...
{
  return BooleanDistrib23023184.init(exp(1.00000000*_mem_tau1->getval()*_mem_rho->getval()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib23023184.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib23023184.init(exp(1.00000000*_mem_tau1->getcache()*_mem_rho->getcache()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib23023184.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib23023184.init(exp(1.00000000*_mem_tau1->getval()*_mem_rho->getval()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib23023184.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib23023184.init(exp(1.00000000*_mem_tau1->getcache()*_mem_rho->getcache()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib23023184.gen());
}
...
{
  return Gaussian23027312.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian23027312.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian23027312.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian23027312.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian23027312.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian23027312.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian23027312.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian23027312.gen());
}
