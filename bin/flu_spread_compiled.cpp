...
void _print_answer();
const int _TOT_LOOP = 2000000;
const int _BURN_IN = 1999995;
int _tot_round = -1999995;
...
Gamma Gamma140674939929984;
Gamma Gamma140674939930320;
TruncatedGauss TruncatedGauss140674939931168;
TruncatedGauss TruncatedGauss140674939931744;
Gaussian Gaussian140674939931504;
BooleanDistrib BooleanDistrib140674939939248;
BooleanDistrib BooleanDistrib140674939943888;
Gaussian Gaussian140674940798448;
Gaussian Gaussian140674939962608;
...
void _init_storage()
{
  ...
  Gamma140674939929984.init(1.05000000,0.50000000);
  Gamma140674939930320.init(3.00000000,0.10000000);
  TruncatedGauss140674939931168.init(0.75000000,0.50000000,0.000000,2.00000000);
  TruncatedGauss140674939931744.init(0.75000000,0.50000000,0.000000,2.00000000);
  Gaussian140674939931504.init(-5.00000000,0.10000000);
...
{
  return Gamma140674939929984.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma140674939929984.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma140674939929984.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma140674939929984.gen();
}
...
{
  return Gamma140674939930320.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma140674939930320.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma140674939930320.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma140674939930320.gen();
}
...
{
  return TruncatedGauss140674939931168.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss140674939931168.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss140674939931168.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss140674939931168.gen();
}
...
{
  return TruncatedGauss140674939931744.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss140674939931744.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=TruncatedGauss140674939931744.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=TruncatedGauss140674939931744.gen();
}
...
{
  return Gaussian140674939931504.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian140674939931504.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian140674939931504.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian140674939931504.gen();
}
...
{
  return BooleanDistrib140674939939248.init(exp(1.00000000*_mem_tau1->getval()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib140674939939248.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib140674939939248.init(exp(1.00000000*_mem_tau1->getcache()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib140674939939248.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib140674939939248.init(exp(1.00000000*_mem_tau1->getval()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib140674939939248.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib140674939939248.init(exp(1.00000000*_mem_tau1->getcache()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib140674939939248.gen());
}
...
{
  return BooleanDistrib140674939943888.init(exp(1.00000000*_mem_tau1->getval()*_mem_rho->getval()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib140674939943888.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib140674939943888.init(exp(1.00000000*_mem_tau1->getcache()*_mem_rho->getcache()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib140674939943888.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib140674939943888.init(exp(1.00000000*_mem_tau1->getval()*_mem_rho->getval()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib140674939943888.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib140674939943888.init(exp(1.00000000*_mem_tau1->getcache()*_mem_rho->getcache()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib140674939943888.gen());
}
...
{
  return Gaussian140674940798448.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140674940798448.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian140674940798448.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140674940798448.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian140674940798448.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140674940798448.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian140674940798448.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140674940798448.gen());
}
...
int main()
{
  ...
  printf("\nsample time: %fs (#iter = %d)\n",__elapsed_seconds.count(),2000000);
  swift::_print_answer();
