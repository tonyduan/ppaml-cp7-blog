...
Gamma Gamma12563184;
Gamma Gamma12563504;
Gaussian Gaussian12563888;
Gaussian Gaussian12564272;
Gaussian Gaussian12569008;
BooleanDistrib BooleanDistrib12571664;
BooleanDistrib BooleanDistrib12574176;
Gaussian Gaussian12576576;
Gaussian Gaussian12653440;
...
void _init_storage()
{
  ...
  Gamma12562816.init(0.50000000,0.10000000);
  Gamma12563184.init(3.00000000,0.10000000);
  Gamma12563504.init(10.00000000,0.10000000);
  Gaussian12563888.init(0.000000,10.00000000);
  Gaussian12564272.init(0.000000,10.00000000);
...
{
  return Gamma12562816.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma12562816.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma12562816.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma12562816.gen();
}
...
{
  return Gamma12563184.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma12563184.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma12563184.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma12563184.gen();
}
...
{
  return Gamma12563504.loglikeli(val);
}
double _Var_tau2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma12563504.loglikeli(_t_val);
}
void _Var_tau2::sample()
{
  val=Gamma12563504.gen();
}
void _Var_tau2::sample_cache()
{
  cache_val=Gamma12563504.gen();
}
...
{
  return Gaussian12563888.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian12563888.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=Gaussian12563888.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=Gaussian12563888.gen();
}
...
{
  return Gaussian12564272.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian12564272.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian12564272.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian12564272.gen();
}
...
{
  return Gaussian12569008.init(0.000000,__fixed_D[c]),Gaussian12569008.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian12569008.init(0.000000,__fixed_D[c]),Gaussian12569008.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian12569008.init(0.000000,__fixed_D[c]),Gaussian12569008.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian12569008.init(0.000000,__fixed_D[c]),Gaussian12569008.gen());
}
...
{
  return BooleanDistrib12571664.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib12571664.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib12571664.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib12571664.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib12571664.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib12571664.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib12571664.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib12571664.gen());
}
...
{
  return BooleanDistrib12574176.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib12574176.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib12574176.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib12574176.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib12574176.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib12574176.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib12574176.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib12574176.gen());
}
...
{
  return Gaussian12576576.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian12576576.loglikeli(val);
}
double _Var_noise::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian12576576.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian12576576.loglikeli(_t_val);
}
void _Var_noise::sample()
{
  val=(Gaussian12576576.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian12576576.gen());
}
void _Var_noise::sample_cache()
{
  cache_val=(Gaussian12576576.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian12576576.gen());
}
