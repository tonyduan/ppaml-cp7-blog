...
Gamma Gamma41046400;
Gamma Gamma41046768;
Gaussian Gaussian41047120;
Gaussian Gaussian41047504;
Gaussian Gaussian41053456;
BooleanDistrib BooleanDistrib41056048;
BooleanDistrib BooleanDistrib41058512;
Gaussian Gaussian41063456;
Gaussian Gaussian41121248;
...
void _init_storage()
{
  ...
  Gamma41046400.init(1.05000000,0.50000000);
  Gamma41046768.init(3.00000000,0.10000000);
  Gaussian41047120.init(0.000000,2.50000000);
  Gaussian41047504.init(0.000000,2.50000000);
...
{
  return Gamma41046400.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma41046400.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma41046400.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma41046400.gen();
}
...
{
  return Gamma41046768.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma41046768.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma41046768.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma41046768.gen();
}
...
{
  return Gaussian41047120.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian41047120.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=Gaussian41047120.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=Gaussian41047120.gen();
}
...
{
  return Gaussian41047504.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian41047504.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian41047504.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian41047504.gen();
}
...
{
  return Gaussian41053456.init(0.000000,__fixed_D[c]),Gaussian41053456.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian41053456.init(0.000000,__fixed_D[c]),Gaussian41053456.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian41053456.init(0.000000,__fixed_D[c]),Gaussian41053456.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian41053456.init(0.000000,__fixed_D[c]),Gaussian41053456.gen());
}
...
{
  return BooleanDistrib41056048.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib41056048.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib41056048.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib41056048.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib41056048.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib41056048.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib41056048.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib41056048.gen());
}
...
{
  return BooleanDistrib41058512.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib41058512.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib41058512.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib41058512.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib41058512.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib41058512.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib41058512.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib41058512.gen());
}
...
{
  return Gaussian41063456.init(_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t)+_mem_y[c][t]->getval(),0.00500000),Gaussian41063456.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian41063456.init(_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t)+_mem_y[c][t]->getcache(),0.00500000),Gaussian41063456.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian41063456.init(_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t)+_mem_y[c][t]->getval(),0.00500000),Gaussian41063456.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian41063456.init(_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t)+_mem_y[c][t]->getcache(),0.00500000),Gaussian41063456.gen());
}
