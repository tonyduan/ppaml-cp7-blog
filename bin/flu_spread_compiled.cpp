...
void _print_answer();
const int _TOT_LOOP = 5000000;
const int _BURN_IN = 4999995;
int _tot_round = -4999995;
...
Gamma Gamma19534576;
Gamma Gamma19534896;
Gaussian Gaussian19535280;
Gaussian Gaussian19535664;
Gaussian Gaussian19540400;
BooleanDistrib BooleanDistrib19543056;
BooleanDistrib BooleanDistrib19545568;
Gaussian Gaussian19547968;
Gaussian Gaussian19624832;
...
void _init_storage()
{
  ...
  Gamma19534208.init(0.50000000,0.10000000);
  Gamma19534576.init(3.00000000,0.10000000);
  Gamma19534896.init(10.00000000,0.10000000);
  Gaussian19535280.init(0.000000,10.00000000);
  Gaussian19535664.init(0.000000,10.00000000);
...
{
  return Gamma19534208.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma19534208.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma19534208.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma19534208.gen();
}
...
{
  return Gamma19534576.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma19534576.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma19534576.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma19534576.gen();
}
...
{
  return Gamma19534896.loglikeli(val);
}
double _Var_tau2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma19534896.loglikeli(_t_val);
}
void _Var_tau2::sample()
{
  val=Gamma19534896.gen();
}
void _Var_tau2::sample_cache()
{
  cache_val=Gamma19534896.gen();
}
...
{
  return Gaussian19535280.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian19535280.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=Gaussian19535280.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=Gaussian19535280.gen();
}
...
{
  return Gaussian19535664.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian19535664.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian19535664.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian19535664.gen();
}
...
{
  return Gaussian19540400.init(0.000000,__fixed_D[c]),Gaussian19540400.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian19540400.init(0.000000,__fixed_D[c]),Gaussian19540400.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian19540400.init(0.000000,__fixed_D[c]),Gaussian19540400.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian19540400.init(0.000000,__fixed_D[c]),Gaussian19540400.gen());
}
...
{
  return BooleanDistrib19543056.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib19543056.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib19543056.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib19543056.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib19543056.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib19543056.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib19543056.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib19543056.gen());
}
...
{
  return BooleanDistrib19545568.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib19545568.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib19545568.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib19545568.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib19545568.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib19545568.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib19545568.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib19545568.gen());
}
...
{
  return Gaussian19547968.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian19547968.loglikeli(val);
}
double _Var_noise::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian19547968.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian19547968.loglikeli(_t_val);
}
void _Var_noise::sample()
{
  val=(Gaussian19547968.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian19547968.gen());
}
void _Var_noise::sample_cache()
{
  cache_val=(Gaussian19547968.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian19547968.gen());
}
...
int main()
{
  ...
  printf("\nsample time: %fs (#iter = %d)\n",__elapsed_seconds.count(),5000000);
  swift::_print_answer();
