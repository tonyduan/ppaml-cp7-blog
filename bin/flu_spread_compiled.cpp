...
const int _BURN_IN = 199999990;
int _tot_round = -199999990;
const double __fixed_rho = 0.05000000;
...
Gaussian Gaussian40692736;
BooleanDistrib BooleanDistrib40704208;
BooleanDistrib BooleanDistrib40708208;
Gaussian Gaussian40712480;
Gaussian Gaussian40770256;
...
void _init_storage()
{
  ...
  Gaussian40692736.init(-4.00000000,0.01000000);
...
{
  return Gaussian40692736.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian40692736.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian40692736.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian40692736.gen();
}
...
{
  return BooleanDistrib40704208.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib40704208.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib40704208.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib40704208.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib40704208.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib40704208.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib40704208.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib40704208.gen());
}
...
{
  return BooleanDistrib40708208.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib40708208.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib40708208.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib40708208.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib40708208.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib40708208.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib40708208.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib40708208.gen());
}
...
{
  return Gaussian40712480.init(_mem_bias->getval()+__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t),__fixed_D[c]*9.00000000),Gaussian40712480.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian40712480.init(_mem_bias->getcache()+__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t),__fixed_D[c]*9.00000000),Gaussian40712480.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian40712480.init(_mem_bias->getval()+__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t),__fixed_D[c]*9.00000000),Gaussian40712480.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian40712480.init(_mem_bias->getcache()+__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t),__fixed_D[c]*9.00000000),Gaussian40712480.gen());
}
