...
TruncatedGauss TruncatedGauss27087184;
TruncatedGauss TruncatedGauss27087696;
Gaussian Gaussian27088080;
BooleanDistrib BooleanDistrib27099408;
BooleanDistrib BooleanDistrib27103408;
Gaussian Gaussian27107680;
Gaussian Gaussian27165520;
...
void _init_storage()
{
  ...
  TruncatedGauss27087184.init(0.25000000,0.10000000,0.10000000,0.70000000);
  TruncatedGauss27087696.init(0.25000000,0.10000000,0.10000000,0.70000000);
  Gaussian27088080.init(-4.00000000,0.01000000);
...
{
  return TruncatedGauss27087184.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss27087184.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss27087184.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss27087184.gen();
}
...
{
  return TruncatedGauss27087696.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss27087696.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=TruncatedGauss27087696.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=TruncatedGauss27087696.gen();
}
...
{
  return Gaussian27088080.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian27088080.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian27088080.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian27088080.gen();
}
...
{
  return BooleanDistrib27099408.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib27099408.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib27099408.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib27099408.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib27099408.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib27099408.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib27099408.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib27099408.gen());
}
...
{
  return BooleanDistrib27103408.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib27103408.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib27103408.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib27103408.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib27103408.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib27103408.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib27103408.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib27103408.gen());
}
...
{
  return Gaussian27107680.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]*4.50000000),Gaussian27107680.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian27107680.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]*4.50000000),Gaussian27107680.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian27107680.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]*4.50000000),Gaussian27107680.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian27107680.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]*4.50000000),Gaussian27107680.gen());
}
