...
TruncatedGauss TruncatedGauss10022592;
TruncatedGauss TruncatedGauss10023104;
Gaussian Gaussian10023744;
BooleanDistrib BooleanDistrib10034848;
BooleanDistrib BooleanDistrib10038848;
Gaussian Gaussian10042976;
Gaussian Gaussian10129968;
...
void _init_storage()
{
  ...
  TruncatedGauss10022592.init(1.50000000,0.50000000,1.00000000,2.50000000);
  TruncatedGauss10023104.init(0.50000000,0.50000000,0.000000,0.75000000);
  Gaussian10023744.init(-5.00000000,0.10000000);
...
{
  return TruncatedGauss10022592.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss10022592.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss10022592.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss10022592.gen();
}
...
{
  return TruncatedGauss10023104.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss10023104.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=TruncatedGauss10023104.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=TruncatedGauss10023104.gen();
}
...
{
  return Gaussian10023744.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian10023744.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian10023744.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian10023744.gen();
}
...
{
  return BooleanDistrib10034848.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib10034848.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib10034848.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib10034848.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib10034848.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib10034848.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib10034848.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib10034848.gen());
}
...
{
  return BooleanDistrib10038848.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib10038848.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib10038848.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib10038848.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib10038848.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib10038848.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib10038848.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib10038848.gen());
}
...
{
  return Gaussian10042976.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian10042976.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian10042976.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian10042976.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian10042976.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian10042976.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian10042976.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian10042976.gen());
}
