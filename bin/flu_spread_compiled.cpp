...
Gamma Gamma35656432;
Gamma Gamma35656752;
Gaussian Gaussian35657136;
Gaussian Gaussian35657520;
Gaussian Gaussian35662256;
BooleanDistrib BooleanDistrib35664912;
BooleanDistrib BooleanDistrib35667424;
Gaussian Gaussian35669824;
Gaussian Gaussian35746688;
...
void _init_storage()
{
  ...
  Gamma35656064.init(0.50000000,0.10000000);
  Gamma35656432.init(3.00000000,0.10000000);
  Gamma35656752.init(10.00000000,0.10000000);
  Gaussian35657136.init(0.000000,10.00000000);
  Gaussian35657520.init(0.000000,10.00000000);
...
{
  return Gamma35656064.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma35656064.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma35656064.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma35656064.gen();
}
...
{
  return Gamma35656432.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma35656432.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma35656432.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma35656432.gen();
}
...
{
  return Gamma35656752.loglikeli(val);
}
double _Var_tau2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma35656752.loglikeli(_t_val);
}
void _Var_tau2::sample()
{
  val=Gamma35656752.gen();
}
void _Var_tau2::sample_cache()
{
  cache_val=Gamma35656752.gen();
}
...
{
  return Gaussian35657136.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian35657136.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=Gaussian35657136.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=Gaussian35657136.gen();
}
...
{
  return Gaussian35657520.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian35657520.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian35657520.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian35657520.gen();
}
...
{
  return Gaussian35662256.init(0.000000,__fixed_D[c]),Gaussian35662256.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian35662256.init(0.000000,__fixed_D[c]),Gaussian35662256.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian35662256.init(0.000000,__fixed_D[c]),Gaussian35662256.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian35662256.init(0.000000,__fixed_D[c]),Gaussian35662256.gen());
}
...
{
  return BooleanDistrib35664912.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib35664912.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib35664912.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib35664912.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib35664912.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib35664912.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib35664912.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib35664912.gen());
}
...
{
  return BooleanDistrib35667424.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib35667424.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib35667424.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib35667424.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib35667424.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib35667424.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib35667424.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib35667424.gen());
}
...
{
  return Gaussian35669824.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian35669824.loglikeli(val);
}
double _Var_noise::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian35669824.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian35669824.loglikeli(_t_val);
}
void _Var_noise::sample()
{
  val=(Gaussian35669824.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian35669824.gen());
}
void _Var_noise::sample_cache()
{
  cache_val=(Gaussian35669824.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian35669824.gen());
}
