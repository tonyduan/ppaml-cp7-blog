...
Gamma Gamma34386672;
Gamma Gamma34386992;
Gaussian Gaussian34387376;
Gaussian Gaussian34387760;
Gaussian Gaussian34392496;
BooleanDistrib BooleanDistrib34395152;
BooleanDistrib BooleanDistrib34397664;
Gaussian Gaussian34400064;
Gaussian Gaussian34476928;
...
void _init_storage()
{
  ...
  Gamma34386304.init(0.50000000,0.10000000);
  Gamma34386672.init(3.00000000,0.10000000);
  Gamma34386992.init(10.00000000,0.10000000);
  Gaussian34387376.init(0.000000,10.00000000);
  Gaussian34387760.init(0.000000,10.00000000);
...
{
  return Gamma34386304.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma34386304.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma34386304.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma34386304.gen();
}
...
{
  return Gamma34386672.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma34386672.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma34386672.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma34386672.gen();
}
...
{
  return Gamma34386992.loglikeli(val);
}
double _Var_tau2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma34386992.loglikeli(_t_val);
}
void _Var_tau2::sample()
{
  val=Gamma34386992.gen();
}
void _Var_tau2::sample_cache()
{
  cache_val=Gamma34386992.gen();
}
...
{
  return Gaussian34387376.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian34387376.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=Gaussian34387376.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=Gaussian34387376.gen();
}
...
{
  return Gaussian34387760.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian34387760.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian34387760.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian34387760.gen();
}
...
{
  return Gaussian34392496.init(0.000000,__fixed_D[c]),Gaussian34392496.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian34392496.init(0.000000,__fixed_D[c]),Gaussian34392496.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian34392496.init(0.000000,__fixed_D[c]),Gaussian34392496.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian34392496.init(0.000000,__fixed_D[c]),Gaussian34392496.gen());
}
...
{
  return BooleanDistrib34395152.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib34395152.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib34395152.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib34395152.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib34395152.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib34395152.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib34395152.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib34395152.gen());
}
...
{
  return BooleanDistrib34397664.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib34397664.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib34397664.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib34397664.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib34397664.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib34397664.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib34397664.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib34397664.gen());
}
...
{
  return Gaussian34400064.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian34400064.loglikeli(val);
}
double _Var_noise::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian34400064.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian34400064.loglikeli(_t_val);
}
void _Var_noise::sample()
{
  val=(Gaussian34400064.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian34400064.gen());
}
void _Var_noise::sample_cache()
{
  cache_val=(Gaussian34400064.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian34400064.gen());
}
