...
Gamma Gamma14152432;
Gamma Gamma14152752;
Gaussian Gaussian14153136;
Gaussian Gaussian14153520;
Gaussian Gaussian14158256;
BooleanDistrib BooleanDistrib14160912;
BooleanDistrib BooleanDistrib14163424;
Gaussian Gaussian14165824;
Gaussian Gaussian14242688;
...
void _init_storage()
{
  ...
  Gamma14152064.init(0.50000000,0.10000000);
  Gamma14152432.init(3.00000000,0.10000000);
  Gamma14152752.init(10.00000000,0.10000000);
  Gaussian14153136.init(0.000000,10.00000000);
  Gaussian14153520.init(0.000000,10.00000000);
...
{
  return Gamma14152064.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma14152064.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma14152064.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma14152064.gen();
}
...
{
  return Gamma14152432.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma14152432.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma14152432.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma14152432.gen();
}
...
{
  return Gamma14152752.loglikeli(val);
}
double _Var_tau2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma14152752.loglikeli(_t_val);
}
void _Var_tau2::sample()
{
  val=Gamma14152752.gen();
}
void _Var_tau2::sample_cache()
{
  cache_val=Gamma14152752.gen();
}
...
{
  return Gaussian14153136.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian14153136.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=Gaussian14153136.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=Gaussian14153136.gen();
}
...
{
  return Gaussian14153520.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian14153520.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian14153520.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian14153520.gen();
}
...
{
  return Gaussian14158256.init(0.000000,__fixed_D[c]),Gaussian14158256.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian14158256.init(0.000000,__fixed_D[c]),Gaussian14158256.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian14158256.init(0.000000,__fixed_D[c]),Gaussian14158256.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian14158256.init(0.000000,__fixed_D[c]),Gaussian14158256.gen());
}
...
{
  return BooleanDistrib14160912.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib14160912.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib14160912.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib14160912.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib14160912.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib14160912.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib14160912.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib14160912.gen());
}
...
{
  return BooleanDistrib14163424.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib14163424.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib14163424.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib14163424.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib14163424.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib14163424.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib14163424.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib14163424.gen());
}
...
{
  return Gaussian14165824.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian14165824.loglikeli(val);
}
double _Var_noise::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian14165824.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian14165824.loglikeli(_t_val);
}
void _Var_noise::sample()
{
  val=(Gaussian14165824.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian14165824.gen());
}
void _Var_noise::sample_cache()
{
  cache_val=(Gaussian14165824.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian14165824.gen());
}
