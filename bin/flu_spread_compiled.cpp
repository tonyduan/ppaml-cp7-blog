...
Gamma Gamma13370752;
Gamma Gamma13371072;
Gaussian Gaussian13371456;
Gaussian Gaussian13371840;
Gaussian Gaussian13376576;
BooleanDistrib BooleanDistrib13379232;
BooleanDistrib BooleanDistrib13381744;
Gaussian Gaussian13384144;
Gaussian Gaussian13452688;
...
void _init_storage()
{
  ...
  Gamma13370384.init(0.50000000,0.10000000);
  Gamma13370752.init(3.00000000,0.10000000);
  Gamma13371072.init(10.00000000,0.10000000);
  Gaussian13371456.init(0.000000,10.00000000);
  Gaussian13371840.init(0.000000,10.00000000);
...
{
  return Gamma13370384.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma13370384.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma13370384.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma13370384.gen();
}
...
{
  return Gamma13370752.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma13370752.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma13370752.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma13370752.gen();
}
...
{
  return Gamma13371072.loglikeli(val);
}
double _Var_tau2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma13371072.loglikeli(_t_val);
}
void _Var_tau2::sample()
{
  val=Gamma13371072.gen();
}
void _Var_tau2::sample_cache()
{
  cache_val=Gamma13371072.gen();
}
...
{
  return Gaussian13371456.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian13371456.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=Gaussian13371456.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=Gaussian13371456.gen();
}
...
{
  return Gaussian13371840.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian13371840.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian13371840.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian13371840.gen();
}
...
{
  return Gaussian13376576.init(0.000000,__fixed_D[c]),Gaussian13376576.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian13376576.init(0.000000,__fixed_D[c]),Gaussian13376576.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian13376576.init(0.000000,__fixed_D[c]),Gaussian13376576.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian13376576.init(0.000000,__fixed_D[c]),Gaussian13376576.gen());
}
...
{
  return BooleanDistrib13379232.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib13379232.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib13379232.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib13379232.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib13379232.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib13379232.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib13379232.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib13379232.gen());
}
...
{
  return BooleanDistrib13381744.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib13381744.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib13381744.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib13381744.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib13381744.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib13381744.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib13381744.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib13381744.gen());
}
...
{
  return Gaussian13384144.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian13384144.loglikeli(val);
}
double _Var_noise::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian13384144.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian13384144.loglikeli(_t_val);
}
void _Var_noise::sample()
{
  val=(Gaussian13384144.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian13384144.gen());
}
void _Var_noise::sample_cache()
{
  cache_val=(Gaussian13384144.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian13384144.gen());
}
