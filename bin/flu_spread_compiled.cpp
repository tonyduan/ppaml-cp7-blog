...
void _print_answer();
const int _TOT_LOOP = 10;
const int _BURN_IN = 5;
int _tot_round = -5;
...
TruncatedGauss TruncatedGauss140580122357344;
TruncatedGauss TruncatedGauss140580123417520;
Gaussian Gaussian140580123417856;
BooleanDistrib BooleanDistrib140580123426944;
BooleanDistrib BooleanDistrib140580123430768;
Gaussian Gaussian140580123434896;
Gaussian Gaussian140580123439312;
...
void _init_storage()
{
  ...
  TruncatedGauss140580122357344.init(1.35000000,0.50000000,1.00000000,2.00000000);
  TruncatedGauss140580123417520.init(0.30000000,0.50000000,0.000000,0.50000000);
  Gaussian140580123417856.init(-5.00000000,0.10000000);
...
{
  return TruncatedGauss140580122357344.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss140580122357344.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss140580122357344.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss140580122357344.gen();
}
...
{
  return TruncatedGauss140580123417520.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss140580123417520.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=TruncatedGauss140580123417520.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=TruncatedGauss140580123417520.gen();
}
...
{
  return Gaussian140580123417856.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian140580123417856.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian140580123417856.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian140580123417856.gen();
}
...
void _Var_bias::conjugacy_analysis(double& _nxt_val)
{}
...
{
  return BooleanDistrib140580123426944.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib140580123426944.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib140580123426944.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib140580123426944.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib140580123426944.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib140580123426944.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib140580123426944.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib140580123426944.gen());
}
...
{
  return BooleanDistrib140580123430768.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib140580123430768.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib140580123430768.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib140580123430768.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib140580123430768.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib140580123430768.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib140580123430768.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib140580123430768.gen());
}
...
{
  return Gaussian140580123434896.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140580123434896.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian140580123434896.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140580123434896.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian140580123434896.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140580123434896.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian140580123434896.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140580123434896.gen());
}
