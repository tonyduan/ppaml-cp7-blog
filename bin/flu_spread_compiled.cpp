...
TruncatedGauss TruncatedGauss37453504;
TruncatedGauss TruncatedGauss37454016;
Gaussian Gaussian37454656;
BooleanDistrib BooleanDistrib37465760;
BooleanDistrib BooleanDistrib37469760;
Gaussian Gaussian37473888;
Gaussian Gaussian37560880;
...
void _init_storage()
{
  ...
  TruncatedGauss37453504.init(1.25000000,0.50000000,1.00000000,2.00000000);
  TruncatedGauss37454016.init(0.50000000,0.50000000,0.000000,0.75000000);
  Gaussian37454656.init(-5.00000000,0.10000000);
...
{
  return TruncatedGauss37453504.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss37453504.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss37453504.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss37453504.gen();
}
...
{
  return TruncatedGauss37454016.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss37454016.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=TruncatedGauss37454016.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=TruncatedGauss37454016.gen();
}
...
{
  return Gaussian37454656.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian37454656.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian37454656.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian37454656.gen();
}
...
{
  return BooleanDistrib37465760.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib37465760.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib37465760.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib37465760.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib37465760.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib37465760.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib37465760.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib37465760.gen());
}
...
{
  return BooleanDistrib37469760.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib37469760.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib37469760.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib37469760.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib37469760.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib37469760.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib37469760.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib37469760.gen());
}
...
{
  return Gaussian37473888.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian37473888.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian37473888.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian37473888.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian37473888.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian37473888.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian37473888.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian37473888.gen());
}
