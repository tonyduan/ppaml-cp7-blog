...
void _print_answer();
const int _TOT_LOOP = 200000;
const int _BURN_IN = 100000;
int _tot_round = -100000;
...
Gamma Gamma140221861783056;
Gamma Gamma140221861783392;
TruncatedGauss TruncatedGauss140221861784240;
TruncatedGauss TruncatedGauss140221861784816;
Gaussian Gaussian140221861784576;
BooleanDistrib BooleanDistrib140221861793952;
BooleanDistrib BooleanDistrib140221861797776;
Gaussian Gaussian140221861801904;
Gaussian Gaussian140221861806320;
...
void _init_storage()
{
  ...
  Gamma140221861783056.init(1.05000000,0.50000000);
  Gamma140221861783392.init(3.00000000,0.10000000);
  TruncatedGauss140221861784240.init(1.00000000,0.50000000,0.000000,3.00000000);
  TruncatedGauss140221861784816.init(1.00000000,0.50000000,0.000000,3.00000000);
  Gaussian140221861784576.init(-4.00000000,0.10000000);
...
{
  return Gamma140221861783056.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma140221861783056.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma140221861783056.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma140221861783056.gen();
}
...
{
  return Gamma140221861783392.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma140221861783392.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma140221861783392.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma140221861783392.gen();
}
...
{
  return TruncatedGauss140221861784240.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss140221861784240.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss140221861784240.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss140221861784240.gen();
}
...
{
  return TruncatedGauss140221861784816.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss140221861784816.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=TruncatedGauss140221861784816.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=TruncatedGauss140221861784816.gen();
}
...
{
  return Gaussian140221861784576.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian140221861784576.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian140221861784576.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian140221861784576.gen();
}
...
{
  return BooleanDistrib140221861793952.init(exp(1.00000000*_mem_tau1->getval()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib140221861793952.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib140221861793952.init(exp(1.00000000*_mem_tau1->getcache()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib140221861793952.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib140221861793952.init(exp(1.00000000*_mem_tau1->getval()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib140221861793952.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib140221861793952.init(exp(1.00000000*_mem_tau1->getcache()*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib140221861793952.gen());
}
...
{
  return BooleanDistrib140221861797776.init(exp(1.00000000*_mem_tau1->getval()*_mem_rho->getval()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib140221861797776.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib140221861797776.init(exp(1.00000000*_mem_tau1->getcache()*_mem_rho->getcache()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib140221861797776.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib140221861797776.init(exp(1.00000000*_mem_tau1->getval()*_mem_rho->getval()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib140221861797776.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib140221861797776.init(exp(1.00000000*_mem_tau1->getcache()*_mem_rho->getcache()*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib140221861797776.gen());
}
...
{
  return Gaussian140221861801904.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140221861801904.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian140221861801904.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140221861801904.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian140221861801904.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140221861801904.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian140221861801904.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]),Gaussian140221861801904.gen());
}
...
int main()
{
  ...
  printf("\nsample time: %fs (#iter = %d)\n",__elapsed_seconds.count(),200000);
  swift::_print_answer();
