...
TruncatedGauss TruncatedGauss35307632;
Gaussian Gaussian35307824;
Gaussian Gaussian35308320;
BooleanDistrib BooleanDistrib35319600;
BooleanDistrib BooleanDistrib35323600;
Gaussian Gaussian35327872;
Gaussian Gaussian35385712;
...
void _init_storage()
{
  ...
  TruncatedGauss35307632.init(0.25000000,0.10000000,0.10000000,0.70000000);
  Gaussian35307824.init(0.000000,10.00000000);
  Gaussian35308320.init(-4.00000000,0.01000000);
...
{
  return TruncatedGauss35307632.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return TruncatedGauss35307632.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=TruncatedGauss35307632.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=TruncatedGauss35307632.gen();
}
...
{
  return Gaussian35307824.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian35307824.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian35307824.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian35307824.gen();
}
...
{
  return Gaussian35308320.loglikeli(val);
}
double _Var_bias::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian35308320.loglikeli(_t_val);
}
void _Var_bias::sample()
{
  val=Gaussian35308320.gen();
}
void _Var_bias::sample_cache()
{
  cache_val=Gaussian35308320.gen();
}
...
{
  return BooleanDistrib35319600.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib35319600.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib35319600.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib35319600.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib35319600.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()-_mem_bias->getval())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval()-_mem_bias->getval()))),BooleanDistrib35319600.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib35319600.init(exp(1.00000000*__fixed_tau1*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()-_mem_bias->getcache())*(_mem_logit[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache()-_mem_bias->getcache()))),BooleanDistrib35319600.gen());
}
...
{
  return BooleanDistrib35323600.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib35323600.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib35323600.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib35323600.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib35323600.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getval()-_mem_bias->getval())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getval()-_mem_bias->getval()))),BooleanDistrib35323600.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib35323600.init(exp(1.00000000*__fixed_tau1*__fixed_rho*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,0)))][t]->getcache()-_mem_bias->getcache())*(_mem_logit[__fixed_toCounty(toInt(__fixed_spatial_obs(s,1)))][t]->getcache()-_mem_bias->getcache()))),BooleanDistrib35323600.gen());
}
...
{
  return Gaussian35327872.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]*4.50000000),Gaussian35327872.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian35327872.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]*4.50000000),Gaussian35327872.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian35327872.init(_mem_bias->getval()+_mem_beta1->getval()*__fixed_covariates1(c,t)+_mem_beta2->getval()*__fixed_covariates2(c,t),__fixed_D[c]*4.50000000),Gaussian35327872.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian35327872.init(_mem_bias->getcache()+_mem_beta1->getcache()*__fixed_covariates1(c,t)+_mem_beta2->getcache()*__fixed_covariates2(c,t),__fixed_D[c]*4.50000000),Gaussian35327872.gen());
}
