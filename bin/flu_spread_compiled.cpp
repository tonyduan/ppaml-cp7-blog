...
Gamma Gamma140363144702928;
Gaussian Gaussian140363144708576;
BooleanDistrib BooleanDistrib140363144710928;
Gaussian Gaussian140363144715088;
Gaussian Gaussian140363143608560;
...
void _init_storage()
{
  ...
  Gamma140363144702928.init(3.00000000,0.10000000);
...
{
  return Gamma140363144702928.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma140363144702928.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma140363144702928.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma140363144702928.gen();
}
...
{
  return Gaussian140363144708576.init(-4.00000000,__fixed_D[c]/10.00000000),Gaussian140363144708576.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian140363144708576.init(-4.00000000,__fixed_D[c]/10.00000000),Gaussian140363144708576.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian140363144708576.init(-4.00000000,__fixed_D[c]/10.00000000),Gaussian140363144708576.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian140363144708576.init(-4.00000000,__fixed_D[c]/10.00000000),Gaussian140363144708576.gen());
}
...
{
  return BooleanDistrib140363144710928.init(exp(_mem_tau1->getval()*_mem_y[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()*_mem_y[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval())),BooleanDistrib140363144710928.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib140363144710928.init(exp(_mem_tau1->getcache()*_mem_y[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()*_mem_y[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache())),BooleanDistrib140363144710928.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib140363144710928.init(exp(_mem_tau1->getval()*_mem_y[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getval()*_mem_y[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getval())),BooleanDistrib140363144710928.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib140363144710928.init(exp(_mem_tau1->getcache()*_mem_y[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,0)))]->getcache()*_mem_y[c][__fixed_toWeek(toInt(__fixed_temporal_obs(t,1)))]->getcache())),BooleanDistrib140363144710928.gen());
}
...
{
  return Gaussian140363144715088.init(__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t)+_mem_y[c][t]->getval(),0.00010000),Gaussian140363144715088.loglikeli(val);
}
double _Var_logit::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian140363144715088.init(__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t)+_mem_y[c][t]->getcache(),0.00010000),Gaussian140363144715088.loglikeli(_t_val);
}
void _Var_logit::sample()
{
  val=(Gaussian140363144715088.init(__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t)+_mem_y[c][t]->getval(),0.00010000),Gaussian140363144715088.gen());
}
void _Var_logit::sample_cache()
{
  cache_val=(Gaussian140363144715088.init(__fixed_beta1*__fixed_covariates1(c,t)+__fixed_beta2*__fixed_covariates2(c,t)+_mem_y[c][t]->getcache(),0.00010000),Gaussian140363144715088.gen());
}
