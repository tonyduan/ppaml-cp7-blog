...
void _print_answer();
const int _TOT_LOOP = 100000000;
const int _BURN_IN = 99999995;
int _tot_round = -99999995;
...
Gamma Gamma28099312;
Gamma Gamma28099632;
Gaussian Gaussian28100016;
Gaussian Gaussian28100400;
Gaussian Gaussian28105136;
BooleanDistrib BooleanDistrib28107792;
BooleanDistrib BooleanDistrib28110304;
Gaussian Gaussian28112704;
Gaussian Gaussian28189568;
...
void _init_storage()
{
  ...
  Gamma28098944.init(0.50000000,0.10000000);
  Gamma28099312.init(3.00000000,0.10000000);
  Gamma28099632.init(10.00000000,0.10000000);
  Gaussian28100016.init(0.000000,10.00000000);
  Gaussian28100400.init(0.000000,10.00000000);
...
{
  return Gamma28098944.loglikeli(val);
}
double _Var_rho::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma28098944.loglikeli(_t_val);
}
void _Var_rho::sample()
{
  val=Gamma28098944.gen();
}
void _Var_rho::sample_cache()
{
  cache_val=Gamma28098944.gen();
}
...
{
  return Gamma28099312.loglikeli(val);
}
double _Var_tau1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma28099312.loglikeli(_t_val);
}
void _Var_tau1::sample()
{
  val=Gamma28099312.gen();
}
void _Var_tau1::sample_cache()
{
  cache_val=Gamma28099312.gen();
}
...
{
  return Gamma28099632.loglikeli(val);
}
double _Var_tau2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gamma28099632.loglikeli(_t_val);
}
void _Var_tau2::sample()
{
  val=Gamma28099632.gen();
}
void _Var_tau2::sample_cache()
{
  cache_val=Gamma28099632.gen();
}
...
{
  return Gaussian28100016.loglikeli(val);
}
double _Var_beta1::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian28100016.loglikeli(_t_val);
}
void _Var_beta1::sample()
{
  val=Gaussian28100016.gen();
}
void _Var_beta1::sample_cache()
{
  cache_val=Gaussian28100016.gen();
}
...
{
  return Gaussian28100400.loglikeli(val);
}
double _Var_beta2::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian28100400.loglikeli(_t_val);
}
void _Var_beta2::sample()
{
  val=Gaussian28100400.gen();
}
void _Var_beta2::sample_cache()
{
  cache_val=Gaussian28100400.gen();
}
...
{
  return Gaussian28105136.init(0.000000,__fixed_D[c]),Gaussian28105136.loglikeli(val);
}
double _Var_y::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian28105136.init(0.000000,__fixed_D[c]),Gaussian28105136.loglikeli(_t_val);
}
void _Var_y::sample()
{
  val=(Gaussian28105136.init(0.000000,__fixed_D[c]),Gaussian28105136.gen());
}
void _Var_y::sample_cache()
{
  cache_val=(Gaussian28105136.init(0.000000,__fixed_D[c]),Gaussian28105136.gen());
}
...
{
  return BooleanDistrib28107792.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib28107792.loglikeli(val);
}
double _Var_temporal_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib28107792.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib28107792.loglikeli(_t_val);
}
void _Var_temporal_edge::sample()
{
  val=(BooleanDistrib28107792.init(exp(_mem_tau1->getval()*_mem_y[c][t]->getval()*_mem_y[c][__fixed_toWeek(t-1)]->getval())),BooleanDistrib28107792.gen());
}
void _Var_temporal_edge::sample_cache()
{
  cache_val=(BooleanDistrib28107792.init(exp(_mem_tau1->getcache()*_mem_y[c][t]->getcache()*_mem_y[c][__fixed_toWeek(t-1)]->getcache())),BooleanDistrib28107792.gen());
}
...
{
  return BooleanDistrib28110304.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib28110304.loglikeli(val);
}
double _Var_spatial_edge::getcachelikeli()
{
  auto _t_val = getcache();
  return BooleanDistrib28110304.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib28110304.loglikeli(_t_val);
}
void _Var_spatial_edge::sample()
{
  val=(BooleanDistrib28110304.init(exp(_mem_tau1->getval()*_mem_rho->getval()*_mem_y[c1][t]->getval()*_mem_y[c2][t]->getval())),BooleanDistrib28110304.gen());
}
void _Var_spatial_edge::sample_cache()
{
  cache_val=(BooleanDistrib28110304.init(exp(_mem_tau1->getcache()*_mem_rho->getcache()*_mem_y[c1][t]->getcache()*_mem_y[c2][t]->getcache())),BooleanDistrib28110304.gen());
}
...
{
  return Gaussian28112704.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian28112704.loglikeli(val);
}
double _Var_noise::getcachelikeli()
{
  auto _t_val = getcache();
  return Gaussian28112704.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian28112704.loglikeli(_t_val);
}
void _Var_noise::sample()
{
  val=(Gaussian28112704.init(0.000000,1.00000000/_mem_tau2->getval()),Gaussian28112704.gen());
}
void _Var_noise::sample_cache()
{
  cache_val=(Gaussian28112704.init(0.000000,1.00000000/_mem_tau2->getcache()),Gaussian28112704.gen());
}
...
int main()
{
  ...
  printf("\nsample time: %fs (#iter = %d)\n",__elapsed_seconds.count(),100000000);
  swift::_print_answer();
